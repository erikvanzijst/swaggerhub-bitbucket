...
@ApiModel(description = "A paginated list of repositories.")
...
public class PaginatedRepositories   {
  ...
  private List<Repository> values = new ArrayList<Repository>();
   ...
   **/
  public PaginatedRepositories next(String next) {
    this.next = next;
    return this;
  }
  ...
  /**
   **/
  public PaginatedRepositories values(List<Repository> values) {
    this.values = values;
    return this;
  }
   ...
   * minimum: 1.0
   **/
  public PaginatedRepositories pagelen(Integer pagelen) {
   ...
   * minimum: 0.0
   **/
  public PaginatedRepositories size(Integer size) {
    this.size = size;
    return this;
  }
   ...
   * minimum: 1.0
   **/
  public PaginatedRepositories page(Integer page) {
    this.page = page;
    return this;
  }
   ...
   **/
  public PaginatedRepositories previous(String previous) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedRepositories paginatedRepositories = (PaginatedRepositories) o;
    return Objects.equals(this.next, paginatedRepositories.next) &&
        Objects.equals(this.values, paginatedRepositories.values) &&
        Objects.equals(this.pagelen, paginatedRepositories.pagelen) &&
        Objects.equals(this.size, paginatedRepositories.size) &&
        Objects.equals(this.page, paginatedRepositories.page) &&
        Objects.equals(this.previous, paginatedRepositories.previous);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedRepositories {\n");
