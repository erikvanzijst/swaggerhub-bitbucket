...
@ApiModel(description = "A paginated list of users.")
...
public class PaginatedUsers   {
   ...
   **/
  public PaginatedUsers next(String next) {
    this.next = next;
    return this;
  }
  ...
  /**
   **/
  public PaginatedUsers values(List<User> values) {
    this.values = values;
    return this;
  }
   ...
   * minimum: 1.0
   **/
  public PaginatedUsers pagelen(Integer pagelen) {
   ...
   * minimum: 0.0
   **/
  public PaginatedUsers size(Integer size) {
    this.size = size;
    return this;
  }
   ...
   * minimum: 1.0
   **/
  public PaginatedUsers page(Integer page) {
    this.page = page;
    return this;
  }
   ...
   **/
  public PaginatedUsers previous(String previous) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.next, paginatedUsers.next) &&
        Objects.equals(this.values, paginatedUsers.values) &&
        Objects.equals(this.pagelen, paginatedUsers.pagelen) &&
        Objects.equals(this.size, paginatedUsers.size) &&
        Objects.equals(this.page, paginatedUsers.page) &&
        Objects.equals(this.previous, paginatedUsers.previous);
  }
