...
import io.swagger.client.model.IssueAttachment;
...
@ApiModel(description = "A paginated list of issue attachments.")
...
public class PaginatedIssueAttachments   {
  ...
  private List<IssueAttachment> values = new ArrayList<IssueAttachment>();
   ...
   **/
  public PaginatedIssueAttachments next(String next) {
    this.next = next;
    return this;
  }
   ...
   **/
  public PaginatedIssueAttachments previous(String previous) {
