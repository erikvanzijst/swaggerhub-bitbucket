...
@ApiModel(description = "A paginated list of issue tracker milestones.")
...
public class PaginatedMilestones   {
  ...
  private List<Milestone> values = new ArrayList<Milestone>();
   ...
   **/
  public PaginatedMilestones next(String next) {
    this.next = next;
    return this;
  }
  ...
  /**
   **/
  public PaginatedMilestones values(List<Milestone> values) {
    this.values = values;
    return this;
  }
  ...
  @JsonProperty("values")
  public List<Milestone> getValues() {
    return values;
  }
  public void setValues(List<Milestone> values) {
    this.values = values;
  }
   ...
   **/
  public PaginatedMilestones previous(String previous) {
