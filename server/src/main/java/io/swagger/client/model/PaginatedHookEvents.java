...
import io.swagger.client.model.HookEvent;
...
@ApiModel(description = "A paginated list of webhook types available to subscribe on.")
...
public class PaginatedHookEvents   {
  ...
  private List<HookEvent> values = new ArrayList<HookEvent>();
   ...
   **/
  public PaginatedHookEvents next(String next) {
    this.next = next;
    return this;
  }
  ...
  /**
   **/
  public PaginatedHookEvents values(List<HookEvent> values) {
    this.values = values;
    return this;
  }
  ...
  @JsonProperty("values")
  public List<HookEvent> getValues() {
    return values;
  }
  public void setValues(List<HookEvent> values) {
    this.values = values;
  }
   ...
   * minimum: 1.0
   **/
  public PaginatedHookEvents pagelen(Integer pagelen) {
   ...
   * minimum: 0.0
   **/
  public PaginatedHookEvents size(Integer size) {
    this.size = size;
    return this;
  }
   ...
   * minimum: 1.0
   **/
  public PaginatedHookEvents page(Integer page) {
    this.page = page;
    return this;
  }
   ...
   **/
  public PaginatedHookEvents previous(String previous) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedHookEvents paginatedHookEvents = (PaginatedHookEvents) o;
    return Objects.equals(this.next, paginatedHookEvents.next) &&
        Objects.equals(this.values, paginatedHookEvents.values) &&
        Objects.equals(this.pagelen, paginatedHookEvents.pagelen) &&
        Objects.equals(this.size, paginatedHookEvents.size) &&
        Objects.equals(this.page, paginatedHookEvents.page) &&
        Objects.equals(this.previous, paginatedHookEvents.previous);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedHookEvents {\n");
