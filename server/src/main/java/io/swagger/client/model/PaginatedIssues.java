...
@ApiModel(description = "A paginated list of issues.")
...
public class PaginatedIssues   {
  ...
  private List<Issue> values = new ArrayList<Issue>();
   ...
   **/
  public PaginatedIssues next(String next) {
    this.next = next;
    return this;
  }
  ...
  /**
   **/
  public PaginatedIssues values(List<Issue> values) {
    this.values = values;
    return this;
  }
   ...
   * minimum: 1.0
   **/
  public PaginatedIssues pagelen(Integer pagelen) {
   ...
   * minimum: 0.0
   **/
  public PaginatedIssues size(Integer size) {
    this.size = size;
    return this;
  }
   ...
   * minimum: 1.0
   **/
  public PaginatedIssues page(Integer page) {
    this.page = page;
    return this;
  }
   ...
   **/
  public PaginatedIssues previous(String previous) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedIssues paginatedIssues = (PaginatedIssues) o;
    return Objects.equals(this.next, paginatedIssues.next) &&
        Objects.equals(this.values, paginatedIssues.values) &&
        Objects.equals(this.pagelen, paginatedIssues.pagelen) &&
        Objects.equals(this.size, paginatedIssues.size) &&
        Objects.equals(this.page, paginatedIssues.page) &&
        Objects.equals(this.previous, paginatedIssues.previous);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaginatedIssues {\n");
